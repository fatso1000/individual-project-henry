...
exports.sequelize = new sequelize_1.Sequelize("videogames", DB_USER, DB_PWD, {
    host: DB_HOST,
    dialect: "postgres",
    pool: {
        max: 5,
...
exports.sequelize.sync({ force: true }).then(() => {
    const Cod5 = videogame_1.VideogameModel.create({
        name: "Cod5",
    ...
    const Gow2 = videogame_1.VideogameModel.create({
        name: "GoW2",
        description: "Lorem ipsum",
        platforms: ["Netflix", "Youtube"],
        releaseDate: "25/32/1222",
    });
    const aoe2 = videogame_1.VideogameModel.create({
        name: "AOE2",
        description: "Lorem ipsum",
